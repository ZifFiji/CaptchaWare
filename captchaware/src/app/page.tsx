  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center px-4 py-8">
      <div className="mb-12 text-center">
        <h1 className="mb-4 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text font-bold text-5xl text-transparent md:text-6xl">
          CaptchaWare
        </h1>
...
function GameCard({ href, title, color }: { href: string; title: string; color: string }) {
  return (
    <Link href={href} className="group">
      <div className={`${color} transform rounded-xl border border-white/10 p-6 shadow-lg transition-all duration-300 group-hover:scale-105 group-hover:shadow-2xl`}>
